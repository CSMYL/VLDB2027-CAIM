...
def load_crime_baseline_dataset():
    """Load Crime dataset, convert to baseline format"""
...
def load_meps_baseline_dataset():
    """Load MEPS dataset, convert to baseline format"""
...
def load_synthetic_baseline_dataset():
    """Load Synthetic dataset, convert to baseline format"""
    dataset_obj, v, num_classes_dict = load_synthetic_reconstruct_dataset()
    target_idx = len(v) - 1
