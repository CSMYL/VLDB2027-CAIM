...
def get_args():
    ...
    # attentive reg
    parser.add_argument('--reg_lambda', default=1.0, type=float, help='regularization lambda, default 1.0')
    parser.add_argument('--reg_method', type=int, default=0, help='regularization method, i.e., how to calculate the regularization strength, default 0')
    # dataset
...
def run(epoch, model, data_loader, opt_metric, plogger, optimizer=None, namespace='train'):
    ...
    for idx, input in enumerate(data_loader):
        ...
        if optimizer:
            y, reg_loss = model(input, normalization_coefficient, reg_lambda, reg_method, (idx==47))
